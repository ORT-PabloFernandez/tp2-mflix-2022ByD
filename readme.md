...
-GET /api/movies/awards/movieByAwards/?pageSize=[pageSize]&page=[page]

-GET /api/movies/languages/:language/?pageSize=[pageSize]&page=[page]

-GET /api/movies/tomatoes/fresh/?pageSize=[pageSize]&page=[page]
