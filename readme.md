...
-GET /api/movies/:id
-GET /api/movies/ganadoras/ganadoras?pageSize=[pageSize]&page=[page]
-GET /api/movies/porIdioma/:idioma?pageSize=[pageSize]&page=[page]
-GET /api/movies/porFresh/descendente?pageSize=[pageSize]&page=[page]
